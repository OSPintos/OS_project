...
#define fp_to_int_round_nearest(X) /
 (X >= 0 ? ((X + (fixed_point_f / 2)) / fixed_point_f) : ((X - (fixed_point_f / 2)) / fixed_point_f))
...
#define fixed_point_div(X,Y) /
 ((int64_t) X) * fixed_point_f / Y
